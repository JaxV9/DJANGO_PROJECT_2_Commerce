...
#Des modèles: Votre application doit avoir au moins trois modèles en plus du User modèle:
# un pour les listes d'enchères, un pour les offres et un pour les commentaires faits sur les listes d'enchères.
# C'est à vous de décider quels champs chaque modèle devrait avoir et quels devraient être les types de ces champs.
# Vous pouvez avoir des modèles supplémentaires si vous le souhaitez.